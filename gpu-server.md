...
On this page, I will show you how to build a high-performance compute server node with four V100 GPUs for around the same cost as a single RTX 4090.

### Background

For the past couple of years, I have been using the following rig for experimentation and model development (as well as three body simulation and polynomial root fractal generation and other assorted projects): 
