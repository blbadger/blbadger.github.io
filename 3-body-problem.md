...
This topology is not special to points on the $x, y$ plane: on the $y, z$ plane ($y$ on the vertical axis from -20 to 20 and $z$ on the horizontal also ranging from -20 to 20 such that the top left is $(z, y) = (-20, -20)$ and the bottom right is $(z, y) = (20, 20)$) after $50,000$ time steps we have
