...
This sort of qualifier is usually placed near the end of work on a program or type of program, but I think it is important enough to include before the main body of work. This section may be skipped if one is already convinced that neural networks do not provide the solution to every problem.
