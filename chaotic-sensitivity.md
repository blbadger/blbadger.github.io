...
Proof: Take $f$ to be a function in finite dimensional phase space.  This entails that trajectories are unique, and that if $f$ returns to a previous point then $f$ is periodic. 
