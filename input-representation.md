...
While there are undoubtedly more reasons why depth leads to poorer input representations (for untrained models), there is one last of particular note.
