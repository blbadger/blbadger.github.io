...
For reference the near-SOTA e5 Mistral instruct (7 billion parameters) quantized to 4 bits per parameter which was confirmed to not affect retrieval accuracy on a subset of t 94% for inputs with 32 samples at a time. 
